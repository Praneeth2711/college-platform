    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        ...
        <div className="bg-white/[0.03] rounded-xl p-2.5 text-center">
          ...
          <p className="text-white font-semibold text-sm">₹{(college.fees / 100000).toFixed(1)}L</p>
        </div>
        <div className="bg-white/[0.03] rounded-xl p-2.5 text-center">
          <p className="text-white/40 text-[10px] uppercase tracking-wider mb-0.5">Placed</p>
          <p className="text-emerald-400 font-semibold text-sm">{college.placementPercentage}%</p>
        </div>
      </div>
